...
const { getAllComments, getCommentById, getCommentByAuthorId, 
    getCommentByHallId, addComment, updateComment,getCommentByBookId, deleteComment } = require('../controllers/commentController');
...
router.route('/books/:id').get(auth,getCommentByBookId);
